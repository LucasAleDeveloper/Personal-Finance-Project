    ...
    <q-footer reveal elevated class="bg-primary text-white">
      <q-toolbar>
        ...
        Powered by 
              ...
              style="color:#ffffff">@Geome7ricWeasel</a>
        </q-toolbar-title>
      </q-toolbar>
    </q-footer>
...
import ModuloFunciones from 'src/modules/ModuloFunciones.vue'
import ModuloNetwork from 'src/modules/ModuloNetwork.vue'
import ModuloFirebase from 'src/modules/ModuloFirebase.vue'
...
export default {
  ...
  async created()
  {
    ...
    this.firebase= new Vue(ModuloFirebase);
      ...
      intentar_iniciar_sesion_google()
      {
        ...
        firebase.auth()
          ...
          .then((result) => {
            ...
            console.log(user);
            this.firebase.actualizar_usuario_logueado();
